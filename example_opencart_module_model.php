<?php
/**
 * The example class of RFM Model
 * @author Alexander Beletsky
 * @version 20220311
 */
class ModelModuleAlcrfma extends Model {
    /**
     * Populate or change a customers group by they purchases
     * @author Alexander Beletsky
     * @version 20220311
     * @var mixed
     * @return void
    ...
    /**
     * Get avg of totals in all user orders
     * @author Alexander Beletsky
     * @version 20220311
     * @var mixed
     * @return mixed
    ...
    /**
     * Get avg of products counts in all user orders
     * @author Alexander Beletsky
     * @version 20220311
     * @var mixed
     * @return mixed
     */
    public function getAvgAllOrdersProductCount($data=array()){
